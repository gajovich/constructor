(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".map__slider")) new core(".map__slider", {
                modules: [ Scrollbar ],
                observer: true,
                observeParents: true,
                spaceBetween: 22,
                ...
                freeMode: true,
                scrollbar: {
                    el: ".map__slider .swiper-scrollbar",
                    draggable: true
                },
                breakpoints: {
                    0: {
            ...
            if (document.querySelector(".ecosystem__slider")) new core(".ecosystem__slider", {
                modules: [ Scrollbar ],
                observer: true,
                observeParents: true,
                spaceBetween: 16,
                speed: 800,
                scrollbar: {
                    el: ".ecosystem__slider .swiper-scrollbar",
                    draggable: true
                },
                breakpoints: {
                    0: {
            ...
            if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
                ...
                speed: 800,
                scrollbar: {
                    el: ".reviews__slider .swiper-scrollbar",
                    draggable: true
                },
                navigation: {
            ...
            if (document.querySelector(".legacy__slider")) new core(".legacy__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".excellence__slider")) new core(".excellence__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".partnerships__slider")) new core(".partnerships__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".alumni__slider")) new core(".alumni__slider", {
                modules: [ Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                scrollbar: {
                    el: ".alumni__slider .swiper-scrollbar",
                    draggable: true
                },
                breakpoints: {
                    0: {
            ...
            if (document.querySelector(".professors__slider")) new core(".professors__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            let tabSwiper = new core(".persons-tab__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            new core(".persons-main__slider", {
                modules: [ Scrollbar, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 16,
                ...
                scrollbar: {
                    el: ".persons-main__slider .swiper-scrollbar",
                    draggable: true
                },
                on: {}
            });
        ...
        da.init();
        let script_button = document.querySelector(".menu__link--about");
        let submenu = document.querySelector(".menu__submenu");
        document.addEventListener("click", (e => {
            if (e.target == script_button) {
                e.preventDefault();
